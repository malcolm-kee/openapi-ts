...
export const fakeStatusWithNull = (options?: Options) => ensureFaker(options).helpers.arrayElement([
    'active',
    'inactive',
    null
]);
...
export const fakePetOrTag = (options?: Options) => ensureFaker(options).helpers.arrayElement([() => fakePet(options), () => fakeTag(options)])();

export const fakeStringOrNumber = (options?: Options) => ensureFaker(options).helpers.arrayElement([() => ensureFaker(options).string.sample(), () => ensureFaker(options).number.float()])();

export const fakeNullablePetOrTag = (options?: Options) => ensureFaker(options).helpers.arrayElement([
    () => fakePet(options),
    () => fakeTag(options),
    () => null
])();
...
export const fakeShape = (options?: Options) => ensureFaker(options).helpers.arrayElement([() => ({
        ...fakeCircle(options),
...
export const fakeAnimal = (options?: Options) => ensureFaker(options).helpers.arrayElement([() => ({
        ...fakeDog(options),
        type: 'dog' as const
    }), () => ({
        ...fakeCat(options),
