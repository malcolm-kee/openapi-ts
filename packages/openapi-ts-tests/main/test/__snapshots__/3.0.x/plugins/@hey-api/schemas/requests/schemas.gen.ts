...
export const import_RequestSchema = {
    type: 'object',
    oneOf: [
        {
            $ref: '#/components/schemas/ModelWithReadOnlyAndWriteOnlyWritable'
        ...
        {
            $ref: '#/components/schemas/ModelWithArrayReadOnlyAndWriteOnlyWritable'
        }
    ]
} as const;

export const CallWithParametersRequestSchema = {
    nullable: true,
    properties: {},
    type: 'object'
} as const;

export const CallWithWeirdParameterNamesRequestSchema = {
    nullable: true,
    allOf: [
        {
            $ref: '#/components/schemas/ModelWithString'
...
export const GetCallWithOptionalParamRequestSchema = {
    $ref: '#/components/schemas/ModelWithOneOfEnum'
} as const;

export const PostCallWithOptionalParamRequestSchema = {
    properties: {
        offset: {
            nullable: true,
            required: true,
...
export const MultipartRequestRequestSchema = {
    type: 'object',
    properties: {
        content: {
            type: 'string',
...
export const ComplexParamsRequestSchema = {
    required: [
        'key',
        'name',
        'parameters',
...
export const putWithFormUrlEncodedRequestSchema = {
